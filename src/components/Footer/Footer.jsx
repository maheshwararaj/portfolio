...
function Footer() {
  return (
    <footer className="footer--container section-pad" id="contact">
      <div className="footer--link--container">
        <div>
          <h2 className="title">M<span>.</span></h2>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.instagram.com/d.mahi_7"
            ...
            <li>
              <a
                href="https://www.github.com/maheshwararaj"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/maheshwararaj"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Maheshwararaj 👨‍💻</p>
        <div className="footer--social--icon">
                 </div>
      </div>
    </footer>
